...
namespace Fluxly.Forms.Stores
{
    public class TodoItemStore : StoreBase<ObservableCollection<TodoItem>>
    {
        /// <summary>
        ...
        public TodoItemStore()
        {
            ...
            Subscribe<TodoItem>(TodoActionTypes.EDIT_TODO);
            ...
            try
            {
                ...
                switch (eventType)
                {
                    ...
                    case TodoActionTypes.EDIT_TODO:
                        var itemToEdit = Data.FirstOrDefault(t => t.Id == (data as TodoItem).Id);
                        if (itemToEdit != null)
                            itemToEdit.Text = (data as TodoItem).Text;
                        break;
