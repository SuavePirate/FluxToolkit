...
namespace FluxToolkit
{
    ...
    /// <summary>
    /// Implementation of a Dispatcher for subscribing to and firing events.
    /// </summary>
    public class Dispatcher : IDispatcher
    {
        /// <summary>
        /// Retrieve a new instance of the dispatcher for the Singleton factory pattern
        /// </summary>
        /// <value>The instance.</value>
        public static IDispatcher Instance { get; } = new Dispatcher();

        /// <summary>
        /// Construct the sender object from the types and the event type received
        /// </summary>
        ...
        /// <summary>
        /// Defines the filter for dispatching.
        /// </summary>
        delegate bool Filter(object sender);

        /// <summary>
        /// Object to contain the logic of a WeakReference object to determine if a strong reference is required or not.
        /// </summary>
        ...
        /// <summary>
        /// Constructs the subscription object with references built on the types subscribed to the dispatcher.
        /// </summary>
        class Subscription : Tuple<WeakReference, MaybeWeakReference, MethodInfo, Filter>
        {
            ...
            /// <summary>
            /// Invokes the callback registered by the subscriber.
            /// </summary>
        ...
        /// <summary>
        /// Sends the message through the instance factory.
        /// </summary>
        /// <returns>The send.</returns>
        /// <param name="sender">Sender.</param>
        /// <param name="message">Message.</param>
        /// <param name="args">Arguments.</param>
        /// <typeparam name="TSender">The 1st type parameter.</typeparam>
        /// <typeparam name="TArgs">The 2nd type parameter.</typeparam>
        ...
        void IDispatcher.Send<TSender, TArgs>(TSender sender, string message, TArgs args)
        {
            if (sender == null)
        ...
        void IDispatcher.Send<TSender>(TSender sender, string message)
        {
            if (sender == null)
                throw new ArgumentNullException(nameof(sender));
        ...
        void IDispatcher.Subscribe<TSender, TArgs>(object subscriber, string message, Action<TSender, TArgs> callback, TSender source)
        {
            if (subscriber == null)
        ...
        void IDispatcher.Subscribe<TSender>(object subscriber, string message, Action<TSender> callback, TSender source)
        {
            if (subscriber == null)
                throw new ArgumentNullException(nameof(subscriber));
            if (callback == null)
        ...
        void IDispatcher.Unsubscribe<TSender, TArgs>(object subscriber, string message)
        {
        ...
        void IDispatcher.Unsubscribe<TSender>(object subscriber, string message)
        {
        ...
        {
            (Instance as Dispatcher)?._subscriptions.Clear();
        }
    }
